 ...
 * 
 * Endpoint for creating Instagram reels with two slides and Ken Burns effect.
 * Generates 1080x1920 videos with customizable text overlays and transitions.
 */

import fs from 'fs';
import path from 'path';
import { generate2SlidesReel } from '../helpers/video-helper.js';

/**
 * 2 Slides Reel endpoint handler
 * 
 ...
 */
export const reelHandler = async (req, res, config) => {
